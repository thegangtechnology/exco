...
def test_within_right_of(wb: Workbook):
    ...
    rol = WithinLocator(direction='right_of', label=test_table_name, find=same_name_here, perform='below_of')
    result = rol.locate(anchor_cell_location=CellLocation(
        sheet_name="Sheet",
        coordinate="A3"
    ), workbook=wb)
...
def test_within_same_find_right_of(wb: Workbook):
    ...
    rol = WithinLocator(direction='right_of', label=test_table_2_name, find=same_name_here, perform='right_of')
    result = rol.locate(anchor_cell_location=CellLocation(
        sheet_name="Sheet",
        coordinate="A7"
    ), workbook=wb)
    ...
    rol = WithinLocator(direction='right_of', label=test_table_2_name, find=same_name_here, perform='below_of')
    result = rol.locate(anchor_cell_location=CellLocation(
        sheet_name="Sheet",
        coordinate="A3"
    ), workbook=wb)
...
def test_within_same_find_below_of(wb: Workbook):
    ...
    rol = WithinLocator(direction='below_of', label='test table 3', find=below_of_name, perform="right_of")
    result = rol.locate(anchor_cell_location=CellLocation(
        sheet_name="Sheet",
        coordinate="B7"
    ), workbook=wb)
